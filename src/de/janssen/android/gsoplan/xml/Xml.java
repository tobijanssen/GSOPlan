...
public class Xml
{
	...
	public static String readFromURL(URL url,ProgressDialog pd, int connectionTimeout) throws Exception 
	{
	...
	/*
	 * @author Tobias Janssen
	 * Konvertiert den String Container des xml in ein XmlTag
	 * 
	 * @return 			XmlTag-Array das die konvertierten Daten enthält 
	 */
	public XmlTag[] xmlToXmlTagArray() throws Exception
    {
		return xmlToArray(this);
    }
	 ...
	 * Konvertiert den String Container des xml in ein XmlTag
	 * 
	 * @param xml		Xml das im Container den String mit den XML Daten enthält
	 * @return 			XmlTag-Array das die konvertierten Daten enthält 
	 */
	...
	/*
	 * @author Tobias Janssen
	 * Konvertiert den String Container des xml in ein XmlTag mit ProgressDialog
	 * 
	 * @param xml		Xml das im Container den String mit den XML Daten enthält
	 * @param pd		ProgressDialog, der incrementiert werden soll
	 * @return 			XmlTag-Array das die konvertierten Daten enthält 
	 */
	...
	/*
	 * @author Tobias Janssen
	 * Fügt dem XmlArray das übergebene xml-tag zu.
	 * 
