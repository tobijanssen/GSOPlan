...
public class AppPreferences extends PreferenceActivity implements Runnable
{
    ...
    private CharSequence[] resyncListEntries = new CharSequence[] { "sofort", "10min", "30min", "1h", "2h", "3h", "5h",
	    "24h", "nie" };
    private CharSequence[] resyncListEntryValues = new CharSequence[] { "1", "10", "30", "60", "120", "180", "300",
	    "1440", "5256000" };
