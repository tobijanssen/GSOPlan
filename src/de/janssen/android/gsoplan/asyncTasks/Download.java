...
public class Download extends AsyncTask<Boolean, Integer, Boolean>{
	...
	public Download(MyContext ctxt,Boolean setup, Boolean data,String selectedDate,String selectedClass,String selectedType)
	{
		this.ctxt=ctxt;
		this.setupData[0]=setup;
	...
	protected Boolean doInBackground(Boolean... bool) {
		try
	    {
			...
			if(this.setupData[1])
			{
				...
				ctxt.stupid.fetchTimeTableFromNet(this.dateClassType[0], this.dateClassType[1], this.dateClassType[2],ctxt);
			}
	     }
	     catch(Exception e)
	     {
	 ...
	 protected void onPostExecute(Boolean bool) {
	    	if(postrun != null)
	    		postrun.run();
	    	if(ctxt.progressDialog.isShowing())
